...
def _conv2d_grad(op, grad):
    return ops.upstride_conv2d_grad(grad, op.inputs[0], op.inputs[1], op.get_attr("strides"), op.get_attr("padding"), op.get_attr("dilations"), data_format=op.get_attr("data_format"), groups=op.get_attr("groups"))
