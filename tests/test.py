...
class TestTF(unittest.TestCase):
    def test_init(self):
        from tests.test_tf    import TestUpstride as test_upstride_TF
        print("Test case: Tensoflow Baseline")
...
class TestType2(unittest.TestCase):
    def test_init(self):
        print("Test case: Type 2")
        from tests.test_type2 import TestUpstride as test_upstride_t2
