...
![real multiplication](./doc/img/model_tf.png "real multiplication"){width=40%}
...
![complex multiplication](./doc/img/complex_mult.svg "complex multiplication"){width=100%}

And figure 4 shows the optimized version

![complex multiplication](./doc/img/mult_0.1.1.png "complex multiplication"){width=100%}
...
![error](./doc/img/error.png "error"){width=60%}
